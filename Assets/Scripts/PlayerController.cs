...
public class PlayerController : MonoBehaviour
{
    ...
    public float LastOnWallHoldTime { get; private set; }

    //Jump
    private bool _isJumpCut;
    private bool _canHoldWall;
    ...
    private void Update()
    {
        ...
        LastOnWallHoldTime -= Time.deltaTime;
        ...
        if (!IsJumping)
        {
                    ...
                    || (Physics2D.OverlapBox(_backWallCheckPoint.position, _wallCheckSize, 0, _groundLayer) && !IsFacingRight)) && !IsWallJumping)
            {
                ...
                {
                    _canHoldWall = false;
                    LastOnWallHoldTime = Data.OnWallHoldTime;
                }
            }
    ...
    private void FixedUpdate()
    {
        ...
        //Handle Slide
        if (IsSliding && LastOnWallHoldTime <= 0)
            Slide();
    }
