...
public class PlayerData : ScriptableObject
{
    ...
    [Space(5)]
    [Range(0f, 2)] public float accelInAir; //Multipliers applied to acceleration rate when airborne.
    [Range(0f, 2)] public float deccelInAir;
    [Space(5)]
    ...
    public float OnWallHoldTime; //Time after wall jumping the player's movement is slowed for.
